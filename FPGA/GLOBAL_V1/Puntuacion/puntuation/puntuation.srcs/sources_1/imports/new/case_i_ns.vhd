...
begin
    process(clk)
        variable count_temp : integer := 0;  -- Variable para contador temporal
        variable resultado_i : integer := 0; -- Variable para resultado intermedio
        --variable flag : integer := 1;        -- Variable para el flag 
    begin
       ...
       -- if reset = '1' then
        ...
        --elsif enable = '1' then
          ...
          --  if flag = 1 then
            ...
            --end if; 
            resultado <= to_unsigned(resultado_i, 10);
        --resultado <= to_unsigned(resultado_i, 10);  -- Conversión de entero a unsigned
        --end if; 
    end process;
end Behavioral;