...
HD_PWD='C:/Users/usuario/OneDrive/Documentos/GitHub/G23SED/FPGA/GLOBAL_V1/Puntuacion/puntuation/puntuation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log case_i_ns.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source case_i_ns.tcl
