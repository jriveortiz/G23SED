...
HD_PWD='C:/Users/gabri/OneDrive/Documentos/GitHub/G23SED/FPGA/GLOBAL_V1/ESTRUCTURAL_4 - copiaSeg/DISPLAY.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log YAHTZEE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source YAHTZEE.tcl -notrace
