...
HD_PWD='C:/Users/gabri/OneDrive/Escritorio/1 CUATRI 24-25/SISTEMAS DIGITALES/PROYECTO/DISPLAY/DISPLAY.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DISPLAY_PUNTOS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DISPLAY_PUNTOS.tcl -notrace
